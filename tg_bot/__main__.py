...
TECHNO_IMG = "https://telegra.ph/file/8deeea1e8fc2e91bba695.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/moneydropos")],
                                                                                   [InlineKeyboardButton(text="ADD AMELIA HELP BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Subscribe YouTube Channel For Updates",
                                                                       url="https://www.youtube.com/channel/UCFHhpxodtEnE0LEeKVJkZrw")
                                                                                 ]]))
